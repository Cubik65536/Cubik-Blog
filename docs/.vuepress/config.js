...
module.exports = {
  title: "Cubik65536's Blog",
  description: '个人博客,简洁至上,创意满满,专注App开发技术学习与各种折腾经验。个人随笔与Java,Python,Swift,iOS,macOS,git,github等技术文章。', // 描述,以 <meta> 标签渲染到页面html中
  // base: '/', // '/<github仓库名>/'， 默认'/'
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'Java,Python,Swift,iOS,macOS,随笔,git,github,markdown' }],
  ...
  themeConfig: { // 主题配置
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'CUBIK INC. (CUBIK65536)。保留一切权利。除非特别注明，本页内容采用以下授权方式：<a href="https://creativecommons.org/licenses/by-nc-nd/4.0/">CC BY-NC-ND 4.0</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
    ...
    [
      ...
      // },
      {
        choosen: 'gitalk',
        options: {
          clientID: '02944239b1c48eadf4c1',
          clientSecret: '3c8e038552d7aa2a8e9811a90f182e72e231e5a7',
